...
You can build simple widgets, or complex application suites using TweetSharp. The new version is designed to be lighter, faster,
and more intuitive than the original. You write fewer lines of code, make fewer decisions, and get better results.
...
TweetSharp is available on our downloads page as a binary distributable, or you may use NuGet to download it directly into Visual Studio as a package.
The name of the main DLL for TweetSharp v2 is _TweetSharp.dll_.
